...
export class LocationController {
    ...
    @Get(':id')
    @ApiOperation({summary: "Retrieve detailed information for specific location id"})
    ...
    async getmeasuresHistoryByLocationIdl(
        ...
        const history = await this.locationService.getLocationMeasuresHistory(id, timeseries.start, timeseries.end, timeseries.bucketSize, measure);
