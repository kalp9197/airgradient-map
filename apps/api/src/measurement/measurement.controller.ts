...
export class MeasurementController {
    ...
    async getLastMeasurements(
        ...
        const measurementEntity = await this.measurementService.getLastMeasurements(measure, page, pagesize);
    ...
    async getLastMeasurementsByArea(
        ...
        const measurementEntity = await this.measurementService.getLastMeasurementsByArea(area.xmin, area.ymin, area.xmax, area.ymax, measure);
    ...
    async getLastMeasurementsByCluster(
        ...
        const measurementClusterModel = await this.measurementService.getLastMeasurementsByCluster(area.xmin, area.ymin, area.xmax, area.ymax, area.zoom, measure);
